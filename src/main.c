...
dt();
    ...
    printf("Welcome To Easy Terminal, A C Language Based Terminal \n\n");
    ...
    }else if(strcmp(a, "enc") == 0){

        decoder();


    }else if(strcmp(a, "newscreen") == 0){
...
void aboutme(){
 ...
 int x; double y;
   char text1[]=    "\n\n \t\t\t 3a5Y Terminal (v1.0) is a C language Based Problem solver Terminal.  ";
   char text2[]=    "\n\n \t\t\t Hi! My name is Naem azam  ";
   char text3[]=    "\n\n \t\t\t Visit My GitHub for More Information: https://github.com/naemazam ";
   printf("\n\n");
    system("color 0A");
...
void help(){
    ...
    printf("Press 5 =  Easy Games \n");
    printf("Press 6 =  Easy Graphics \n");
...
printf("\nPress Number : ");
   ...
   printf("clr    >>> To clear the screen\n");
    printf("dt     >>> To show date and time\n");
      printf("aboutme    >>> To show my profile \n");
    printf("newscreen  >>> To show start screen\n");
...
printf("enc  >>> Decoder software  \n");
  printf("passwordcheck  >>> Check Your password  \n");
        break;

    case 5:
        printf("\n");
    printf("You can enter the following commands for Easy Games :\n\n");

    printf("guessing  >>> This is a guessing number game \n");
    printf("snake  >>> This is a snake game \n");
    printf("hangman >>> This is a Guessing word Game\n");
     printf("disco >>> This is a Text Color changing Game\n");
   ...
   printf("fiber  >>> Make Beautiful optical Fiver signal (single mode) On terminal  \n");
     printf("art  >>> Make Beautiful word art on terminal  \n");
        break;
